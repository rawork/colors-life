{raSetVar var=title value="Восстановление пароля"}
...
{if $info_message}<div class="alert alert-success">{$info_message}</div>{/if}
  ...
  <div class="control-group">
    <div class="controls">
	  ...
	  <div>&nbsp;</div>
	  <div><a href="/cabinet/">У меня есть пароль. Я хочу войти на сайт.</a></div>
      <div><a href="/cabinet/registration.htm">Хочу зарегистироваться</a></div>
    </div>
  </div>	
</form>
<script>
