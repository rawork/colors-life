          ...
          <td align="center"> {$message}
            <div class="auth-border">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td valign="top"><form name="frmForgot" action="/admin/forgot" method="post">
                  <input type="hidden" name="submited" value="1">
                      <table style="width:100%;border-bottom: 1px dotted #B2BCD9; margin-bottom: 7px;" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          ...
                          <td><input name="_user" type="text" class="pole" size="30"></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td><input name="_email" type="text" class="pole" size="30"></td>
                        </tr>
                        <tr>
